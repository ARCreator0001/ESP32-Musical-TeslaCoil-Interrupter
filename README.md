...
| Part name | Qty required(not ordered due to MOQs) | Source | Price | Actual Price with taxes & shipping |
| --- | --- | --- | --- | --- |
| PCB board fabrication | 1 used 5 MOQ |Lion Circuits or ~~Robu.in~~ | ~~robu(₹3556/$37.7)~~, Lion ₹2983 $31.74 | ~~robu(same)~~,Lion ₹2983 $31.74 |
| 2.54MM male Pin headers | 5 pins(2+3) | Local shop | Already own | Already own |
|Power Switch Latching|1|LCSC|$0.84|$0.84|
|USB C Port Connector|1|LCSC|$1.06|$1.06|
|Tactile Button|3|LCSC|$0.06|$0.06|
|OptoTransmitter HFBR-1521Z|1|LCSC|$7.65|$7.65|
|AMS1117-3.3 regulator|1|LCSC|$1.13|$1.13|
|AMS1117-5.0 regulator|1|LCSC|$1.19|$1.19|
|ESP32S3 Wroom 1 N8|1|LCSC|$5.42|$5.42|
|10uF 25V Aluminum Electrolytic Cap|1|LCSC|$0.49|$0.49|
|100nF 25V 0805 Ceramic cap|8|LCSC|$0.18|$0.18|
|470Ω 150V Thin Film Resistor|1|LCSC|$0.70|$0.70|
|220Ω 0805 Res|1|LCSC|$1.70|$1.70|
|180Ω 0805 Res|1|LCSC|$0.49|$0.49|
|Rotary encoder EC11E18244A5|1|LCSC|$2.05|$2.05|
|Micro SD TF card port|1|LCSC|$0.73|$0.73|
|10K Resistory array 1206|1|robu.in|₹ 2.28 $0.0243|₹ 2.28 $0.0243|
|0805 LED Green|1|robu.in|₹ 2.62 $0.0279|₹ 2.62 $0.0279|
|0805 LED Red|2|robu.in|₹2.36 $0.0252|₹2.36 $0.0252|
|DSS34 diode|2|robu.in|₹ 9.58 $0.1021|₹ 9.58 $0.1021|
|1N4148W 1206 Diode|2|robu.in|₹ 1.70 $0.0181| ₹ 1.70 $0.181|
|SS8050S-FOSAN-SOT-23 Bipolar (BJT)|1|robu.in|₹1.82 $0.0194| ₹1.82 $0.0194|
|510kΩ 0805 res|1|robu.in|₹0.21 $0.0022||
|5.1kΩ 0805 res|2|robu.in|₹ 1.96 $0.0209|₹ 1.96 $0.0209|
|2.2Kohm 0805 res|1|robu.in|₹ 0.42 $0.0045|₹ 0.42 $0.0045|
|47Ω 0805 res|1|robu.in|₹ 0.20 $0.0021|₹ 0.20 $0.0021|
|TS-1088-AR02016 Switch|2|robu.in|₹8.43 $0.0899|₹8.43 $0.0899|
|TLJR106M010S2000-KYOCERA AVX-10uF 10V cap|1|robu.in|₹26 $0.2772|₹26 $0.2772|
|16V 10uF X5R 0805|2|robu.in|₹1.96 $0.0209|₹1.96 $0.0209|
|M2 X 12mm Female to Female Brass with Nickel plating Hex Threaded Standoff Spacer|4|onlyscrews.in|₹24.8 $0.2644|₹24.8 $0.2644|
|M2 X 10mm Hex (Allen) Socket Head High Tensile(12.9) Black oxide screw (Dia. 2mm, Length 10mm)|8|onlyscrews.in|₹28.8 $0.307|₹28.8 $0.307|
|M2 Plain Washer SS304 (ID. 2.1mm OD:4.5mm T:0.5mm)|4|onlyscrews.in|₹2.4 $0.0256|₹2.4 $0.0256|
|M2 Hex Nut Mild Steel with White Zinc Plating (Dia. 2mm)|4|onlyscrews.in|₹4 $0.0426|₹0.0426|
|M2 X 4mm Brass Threaded Inserts (Dia. 2mm, Length 4mm)|8|onlyscrews.in|₹14.4 $0.1535|₹14.4 $0.1535|
...
|Sum||||$57.0207 excluding shipping cost of LCSC of $29.25 and $0.5224 of Robu,LionCircuits is free shipping,OnlyScrews has shipping cost of $0.6397|
|Grand Total|||||$87.4328|
