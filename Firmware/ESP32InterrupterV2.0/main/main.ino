/*
<<<<<<< HEAD:ESP32InterrupterV2.0/main/main.ino
 * oneTesla revived SD interrupter (ESP32)
=======
 * ESP32 Musical Interrupter!
>>>>>>> 12b6cc55e45835253b933070bfa4746bd27f05cb:main/main.ino
 */
#include "constants.h"
#include "data.h"
#include "datatypes.h"
...
<<<<<<< HEAD:ESP32InterrupterV2.0/main/main.ino
    if (key == btnBACK) {
      ...
      return;
=======
    // longpress SELECT to exit Fixed Mode
    if (key == btnSELECT) {
